- **Function**
  ...
  - Defining a Function
    ...
    - Function name must be meaningful. You can use a verb
    ```jsx
    //function definition, function declaration or function body
  ...
  - Parameters and Arguments
    ...
    - Parameters
      ...
      ```
    - Arguments
      - Arguments are the **actual values** you pass into the function when you **call or invoke** it.
  ...
  - Nested Function
    ...
    - inner can’t call outside of the outer function
    - If I want to call the outside outer function, then you have to return the inner function
    ```jsx
    function outer() {
      console.log("This is the outer function");
